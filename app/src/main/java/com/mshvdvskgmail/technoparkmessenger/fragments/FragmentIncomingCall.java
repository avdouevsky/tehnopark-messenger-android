...
public class FragmentIncomingCall extends Fragment {
    ...
    private void inflatePicture(View mRootView) {
        ImageView profileIcon = (ImageView) mRootView.findViewById(R.id.incoming_call_profile_icon);
    ...
    private void addListeners(View mRootView) {
        frameDeny = (FrameLayout) mRootView.findViewById(R.id.button_deny);
...
//                startActivity(myIntent);
        ...
        frameAnswer = (FrameLayout) mRootView.findViewById(R.id.button_answer);
